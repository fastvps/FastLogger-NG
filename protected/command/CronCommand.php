...
class CronCommand extends CConsoleCommand
{
    public function run()
    {
        ...
        $commands = array(
            ...
            "DELETE FROM logs_syslog_ng WHERE (inserted_at < CURRENT_TIMESTAMP - INTERVAL '2' DAY) AND (level = 'warn');",
            "DELETE FROM logs_syslog_ng WHERE (inserted_at < CURRENT_TIMESTAMP - INTERVAL '5' DAY) AND (level = 'error');",
